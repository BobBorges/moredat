...
var recorderDiv = document.getElementById('spnrecorderdiv');
...
const submitButton = document.getElementById('spnSubmitButton');
var mediaRecorder;
...
document.addEventListener("DOMContentLoaded", function(event) { 
    ...
    spnrecorderdiv.style.display = 'none';
});
...
responseType.addEventListener('change', function(){
	...
	if (resp == 'Record response') {
    	...
    	spnrecorderdiv.style.display = 'block';
	} else {
	    writtenResponseDiv.style.display = 'none';
    	commentaryDiv.style.display = 'block';
    	spnrecorderdiv.style.display = 'none';
